    ...
    <div v-if="!activatedNavbar" class="pageContent">
      <div class="setores">
        <ul class="indice">
          ...
          <div>
            <li v-for="setor in setores" :key="setor.id"><a @click="(nomeDoSetor = setor.nome) && (coordenador1 = setor.coordenador1) && (coordenador1Img = getImgURL(setor.img1)) && (fb1 = setor.fb1) && (coordenador2 = setor.coordenador2) && (coordenador2Img = getImgURL(setor.img2)) && (fb2 = setor.fb2) && (coordenador3 = setor.coordenador3) && (coordenador3Img = getImgURL(setor.img3)) && (fb3 = setor.fb3) && (descricao = setor.descricao) && (contacto = setor.contacto)" >
